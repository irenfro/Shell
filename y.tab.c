...
#define WORD 258
#define NOTOKEN 259
#define APPEND_STDO_STDE 260
#define GREAT_STDO_STDE 261
#define APPEND 262
#define GREAT 263
#define LESS 264
#define PIP 265
...
{
       0,    53,    53,    57,    58,    61,    62,    66,    70,    71,
      75,    82,    83,    87,   108,   121,   126,   131,   137,   145,
     152,   156
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "NOTOKEN", "APPEND_STDO_STDE",
  "GREAT_STDO_STDE", "APPEND", "GREAT", "LESS", "PIP", "AMP", "NEWLINE",
...
{
       1,    -4,    -6,    -6,     9,     0,    -6,    -6,    -5,    -6,
      -6,    -6,    -6,     1,    -6,    11,     7,    -6,     8,    18,
      19,    21,    22,    -6,    -6,    -6,    -6,    -6,    -6,    -6,
      -6
};
...
{
       0,     0,    14,     8,     0,     0,     3,     5,    21,    12,
       9,     1,     4,     0,    20,     0,    10,     6,     0,     0,
       0,     0,     0,     7,    13,    11,    18,    19,    17,    15,
      16
};
...
{
      -2,     1,     1,     2,     2,    13,    14,    12,    10,    11,
      24,    26,     3,     3,     0,    17,    18,    19,    20,    21,
      22,    27,    28,    23,    29,    30
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     3,     3,    10,    11,     5,    12,     0,
       3,     3,    12,    12,    -1,    13,     5,     6,     7,     8,
       9,     3,     3,    12,     3,     3
};
...
{
       0,     1,     3,    12,    14,    15,    16,    17,    18,    21,
      12,     0,    16,    10,    11,    22,    19,    16,     5,     6,
       7,     8,     9,    12,     3,    20,     3,     3,     3,     3,
       3
};
...
#line 87 "shell.y" /* yacc.c:1646  */
    {
           ...
           char* temp = getNonEscaped((yyvsp[0].string_val));
...
#line 121 "shell.y" /* yacc.c:1646  */
    {
        ...
        Command::_currentCommand.setOut((yyvsp[0].string_val));
	}
...
#line 126 "shell.y" /* yacc.c:1646  */
    {
       /* printf("   Yacc: insert input \"%s\"\n", $3);*/
        ...
        Command::_currentCommand.setIn((yyvsp[0].string_val));
    }
...
#line 137 "shell.y" /* yacc.c:1646  */
    {
        ...
        Command::_currentCommand.setOut((yyvsp[0].string_val));
        Command::_currentCommand.setErr((yyvsp[0].string_val));
        Command::_currentCommand._append = 1;
    }
